      ...
      <KeyboardAvoidingView style={{}} behavior={Platform.OS === "ios" ? "padding" : "height"}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.MessContainer}>
            ...
            <TextInput keyboardType="ascii-capable" onFocus={closeEmoji} multiline autoCapitalize={'sentences'} autoCorrect={false} style={styles.MessInput} value={mess} placeholder="message" onChangeText={text => setMess(text)} />
      ...
      <>
        ...
        <View style={{height: 250}}>
          <EmojiSelector
            ...
            onEmojiSelected={emoji => setMess(emoji)}
          />
        </View>
      </>
      }
